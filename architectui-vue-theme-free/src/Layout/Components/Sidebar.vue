...
<script>
    ...
    export default {
        ...
        computed: {
            menu(){
                var moduleSidebars = this.$store.getters.getModuleSidebars;
                if (moduleSidebars == undefined){
                    return [];
                }

                
                for(var i=0; i < moduleSidebars.length; i++){
                    console.log(moduleSidebars[i]);
                }

                var menu;
                console.log(this.$store.getters.getModuleSidebars);
